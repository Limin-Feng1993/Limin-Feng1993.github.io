...
先介绍第一种的优缺点。光谱法的主要原理是将气流抽进仪器后，用激光照射气流，其中颗粒物会使光路发生偏移，仪器检测到光路遮挡信号后开始计数。原理简单、操作方便，仪器的价格相对较为便宜，大多数的又轻又小的便携式仪器都是光谱法。代表仪器为TSI的OPS。
...
电&化学的原理是先用有机溶剂加热为蒸汽，在颗粒物表面达到超饱和凝结，达到超饱和后，有机蒸汽的凝结就和湿度或者浓度没有关系了，这时主要是颗粒物的粒径对凝结其主要作用。之所以有个“电”字，是因为接下来，仪器将气流通过接上电流的正极和负极之间。我们知道，一个物质受到电场力的大小是和其质量和所加电荷有关，而电场力又直接决定了物质的运动轨迹。也就是说，大粒径的颗粒物运动轨迹较长，落到较远位置，细粒径颗粒物运动轨迹较短，落到较近的位置，再分别计数。代表性仪器是SMPS和CPC。
